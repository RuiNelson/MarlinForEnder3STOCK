...
This firmware takes 129,634 bytes of the availiable 130,048 bytes of program memory the 1284 after installing the Arduino bootloader, so some sacrifices had to be made:
