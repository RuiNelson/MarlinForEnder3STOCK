...
#define STRING_CONFIG_H_AUTHOR "(Rui Carneiro, Ender 3)" // Who made the changes.
...
#define LCD_BED_LEVELING
  ...
  #define MBL_Z_STEP 0.02    // Step size while manually probing Z axis.
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 117, 235, 20 }
